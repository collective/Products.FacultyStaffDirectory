...
i18ndude rebuild-pot --pot ./FacultyStaffDirectory.pot --merge ./manual.pot --create FacultyStaffDirectory ../ || exit 1
i18ndude sync --pot ./FacultyStaffDirectory.pot ./*/LC_MESSAGES/FacultyStaffDirectory.po

i18ndude rebuild-pot --pot ../i18n/FacultyStaffDirectory-plone.pot --exclude=`../Specialty.py ../Person.py ../FacultyStaffDirectory.py ../interfaces/configuration.py` --create plone ../
