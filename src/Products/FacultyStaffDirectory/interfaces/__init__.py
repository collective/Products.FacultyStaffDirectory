...
from Products.FacultyStaffDirectory.interfaces.browser import IPersonGroupingViewletManager, IPersonGroupingView, ISpecialtyViewletManager, IClassificationViewletManager, ICommitteeViewletManager, IDepartmentViewletManager, ITabularListing, IGalleryListing
