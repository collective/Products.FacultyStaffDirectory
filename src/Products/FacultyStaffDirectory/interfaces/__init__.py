...
from Products.FacultyStaffDirectory.interfaces.content import IPersonGrouping, IClassification, ISpecialty, ICommittee, ICommitteeMembership, ICommitteesFolder, ICourse, IFacultyStaffDirectory, IFacultyStaffDirectoryAddable, IPerson, ISpecialtiesFolder, ISpecialtyInformation, IFacultyStaffDirectoryTool
