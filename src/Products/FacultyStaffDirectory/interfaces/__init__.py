...
from Products.FacultyStaffDirectory.interfaces.browser import IPersonGroupingViewletManager, IPersonGroupingView, ISpecialtyViewletManager, ISpecialtyTabularViewletManager, ISpecialtyGalleryViewletManager, IClassificationViewletManager, ICommitteeViewletManager, ICommitteeGalleryViewletManager, ICommitteeTabularViewletManager, IDepartmentViewletManager, IDepartmentGalleryViewletManager, IDepartmentTabularViewletManager
