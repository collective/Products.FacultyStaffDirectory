...
from Products.FacultyStaffDirectory.interfaces.content import IPersonGrouping, IClassification, ICommittee, ICommitteeMembership, ICommitteesFolder, ICourse, IFacultyStaffDirectory, IFacultyStaffDirectoryAddable, IPerson, IFacultyStaffDirectoryTool
from Products.FacultyStaffDirectory.interfaces.browser import IPersonViewletManager, IPersonOfficeAddressViewletManager, IPersonView, IPersonGroupingViewletManager, IPersonGroupingContainerViewletManager, IPersonGroupingView, IClassificationViewletManager, ICommitteeViewletManager, IListingFormat, ITabularListingFormat, IGalleryListingFormat
