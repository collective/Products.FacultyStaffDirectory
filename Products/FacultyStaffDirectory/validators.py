...
class SequenceValidator(object):
    ...
    def __init__(self, name, validator, description='', **kw):
        ...
        validator - a validator (or ValidatorChain) to run against each item in the sequence. For reasonable results, make sure your chain cites the bad input in its error message. Otherwise, the user won't know what the error message applies to.
        """
        self.name = name
