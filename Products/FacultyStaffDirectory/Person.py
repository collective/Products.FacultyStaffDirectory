...
from Products.FacultyStaffDirectory.permissions import CHANGE_PERSON_IDS
...
Person_schema = atapi.OrderedBaseFolderSchema.copy() + schema.copy()  # noqa + on Schemas does only a shallow copy
...
# with actual links at the top of the page instead of Javascript tabs. This allows us to direct
# people
...
# generates accessor and mutators, among other things
